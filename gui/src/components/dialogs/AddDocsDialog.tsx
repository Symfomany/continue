...
function AddDocsDialog() {
  ...
  return (
    <div className="px-2 pt-4 sm:px-4">
      <div className="">
        <h1 className="mb-0 hidden sm:block">Ajouter de Documentation</h1>
        <h1 className="sm:hidden">Add des fichiers</h1>
        ...
        <div>
          {docsIndexingStatuses.length ? (
            <p className="mt-2 flex flex-row items-center gap-1 p-0 px-1 text-xs text-stone-500">
              ...
              Vous pouvez fermer cette fenêtre lors de l'indexation
            </p>
          ) : null}
        </div>
