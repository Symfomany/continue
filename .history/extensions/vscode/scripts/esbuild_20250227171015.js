import * as esbuild from "esbuild"; // Importer esbuild avec import
import fs from 'fs';          // Importer fs avec import
...
const esbuildConfig = {
  ...
  format: "esm",       //  Assure-toi que c'est bien "esm"
  target: "esnext",    //  Et que tu as bien une cible comme "esnext"
  platform: "node",
