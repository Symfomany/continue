...
interface LoginResponse {
  account?: any; // `any` si tu ne connais pas le type exact de `account`, sinon remplace par le type approprié
  [key: string]: any; // Pour permettre d'autres propriétés non spécifiées
}
