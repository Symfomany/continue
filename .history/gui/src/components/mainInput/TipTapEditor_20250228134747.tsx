...
function TipTapEditor(props: TipTapEditorProps) {
  ...
  const estimateTokenCount = (text: String) => {
     console.log("Texte reçu :", text); // Vérifiez le texte
    const tokens = text.split(/\s+/);
    console.log("Tokens calculés :", tokens); // Vérifiez les tokens
    const count = tokens.length;
    console.log("Nombre de tokens :", count); // Vérifiez le nombre
    return count;
  };
