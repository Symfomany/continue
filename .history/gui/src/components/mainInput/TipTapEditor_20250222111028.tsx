...
const StyledEditorContent = styled(EditorContent)`
  transition: height 0.3s ease-in-out, border-color 0.15s ease-in-out;
  height: auto;
...
function TipTapEditor(props: TipTapEditorProps) {
  ...
  function getPlaceholderText(
    ...
    if (historyLength === 0) {
      ...
      return "Continuez la discussion 😃";
    }
  ...
  return (
    ...
    >
        <div
          className={`px-2.5 pb-1 pt-2 transition-all duration-300 ${
            isFocused ? "h-[calc(100%+10px)] border-white" : "h-full"
          }`}
        >
        <StyledEditorContent
          ...
          spellCheck={false}
          editor={editor}
          onFocus={() => console.log('laaaaaa !!!!!!! ')} // Ajoute la classe au focus
