    ...
    if (historyLength === 0) {
      ...
      return welcomeMessages[randomIndex] + " (Utilisez '@' pour le contexte)";
       ...
       const messages = [
        ...
        "Le code, c'est comme une aventure, et je suis votre guide ! 🗺️ Alors, quelle est la prochaine étape ?",
        ...
        "Je suis à votre écoute. Quel est le prochain blocage que nous allons résoudre ensemble ? 🤝",
        "Coding is fun! Alors, on continue ? 😄",
        "C'est le moment de passer à la vitesse supérieure ! Que voulez-vous que je fasse maintenant ? 🏎️",
        "Encore un petit effort et vous y êtes presque ! Comment puis-je vous aider à franchir la ligne d'arrivée ? 🏁",
