              ...
              <Listbox value={selectedTemplate} onChange={handleTemplateSelect}>
                  <div className="relative mt-1">
                      ...
                      <Transition
                          ...
                          leaveTo="opacity-0"
                      >
                          <Listbox.Options className="absolute mt-1 max-h-60 w-full bg-white overflow-auto rounded-md py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                              {messageTemplates.map((template, templateIdx) => (
                                  <Listbox.Option
                                      key={templateIdx}
                                      className={({ active }) =>
                                          ` cursor-default select-none py-2 pl-10  ${active ? 'bg-amber-100 text-amber-900' : 'text-gray-900'
                                          }`
                                      }
                                      value={template}
                                  >
