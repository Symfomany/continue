...
export const vscForeground = `var(--vscode-editor-foreground, #FFFFFF)`;
...
export const vscSelectionBackground = `var(--vscode-list-activeSelectionBackground, rgba(255, 223, 0))`;
export const vscFocusBorder = `var(--vscode-focusBorder, #007ACC)`;
