    ...
    <div style={{ fontSize: getFontSize() }}>
      <div className="relative mx-auto mb-2 mt-3 flex items-stretch justify-center space-x-2 px-2">
        <input
          ...
          ref={searchInputRef}
          placeholder="Rechercher une disciussion"
          type="text"
          value={searchTerm}
      ...
      {filteredAndSortedSessions.length === 0 && (
        <div className="m-4 text-center">
          Aucune discussion de trouvées . Cliquer sur le boutton "+" ou utiliser le raccourci: <code>{getMetaKeyLabel()}</code>
          {` `}
          <code>L</code>
        </div>
      )}
