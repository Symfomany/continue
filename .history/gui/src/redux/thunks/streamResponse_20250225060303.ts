  ...
  async (
    ...
    await dispatch(
      streamThunkWrapper(async () => {
        ...
        const prompt = `${personna}, qui travaille en tant que Développeur chez Enedis. Réponds à la question en français: ${editorState && editorState.content ? editorState.content.text || test }`;
