...
>(
  "chat/streamResponse",
  async (
    { editorState, modifiers, index, promptPreamble, personna },
    ...
    await dispatch(
      streamThunkWrapper(async () => {
        ...
        const prompt = `${personna}, qui travaille en tant que Développeur chez Enedis.  Réponds à la question en français: ${JSON.stringify(editorState.content)} ${editorState.content.text}`;
