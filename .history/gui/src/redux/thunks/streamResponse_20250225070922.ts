  ...
  async (
    ...
    await dispatch(
      streamThunkWrapper(async () => {
        ...
        const prompt = `${personna}, qui travaille en tant que développeur chez Enedis. Réponds à la question en français: ${editorState && editorState.text ? editorState.text  : ""}`;
