  ...
  async (
    ...
    await dispatch(
      streamThunkWrapper(async () => {
        ...
        if (!commandAndInput) {
            const system = `Tu es ${personna}, qui travailles en tant que développeur chez Enedis et répondra en français uniquement. }`;
          ...
          const combinedMessages = [...messagesWithContext, ...messagesWithPersonna];


          unwrapResult(await dispatch(streamNormalInput(combinedMessages as ChatMessage[])));
