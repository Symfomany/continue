...
function ConfigPage() {
  ...
  useEffect(() => {
    // Synchronise l'état local avec Redux à chaque changement de personnaFromRedux
  ...
  function updatePersonna() {
    ...
    showToast('Personna updated successfully!', { type: 'success' });
  }
              ...
              <div className="flex flex-col gap-4">
                {hubEnabled ? (
                  ...
                  <>
                    ...
                    <p>Pour commencer, decris ton personna ici</p>
                    <Textarea
                        value={personna}
                        rows={5}
                        onChange={(e) => {
                        ...
                        placeholder="Ex: Développeur Java avec le framework Spring, SpringBot, Angular en frontend, Git en Docker"
                      />

                      <Button
                        onClick={updatePersonna}>Mettre a jour mon personna</Button>
                  </>
                )}
