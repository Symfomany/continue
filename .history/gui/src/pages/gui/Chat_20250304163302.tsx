...
const conseils = [
  "Java : Code propre, vie sereine ! 🧘",
  "Angular : Observables : votre ami asynchrone ! 🤝",
  "Python : Simplicité est la clé. 🔑",
  "Java : Testez, testez, testez ! 🙌",
  "Angular : Composants modulaires = maintenance facile. 🧩",
  "Python : Commentez toujours ! ✍️",
  "Java : Design patterns : apprenez des maîtres. 👨‍🏫",
  "Angular : Architecture claire = projet durable. 🏡",
  "Python : Virtualenv : isolez vos projets. 📦",
  "Java : Réutilisez les bibliothèques ! ⚙️",
  "Angular : Optimisez les performances ! 🚀",
  "Python : Documentez votre API. 📖",
  "DevOps : Automatisez tout ! 🤖",
  "Docker : Conteneurisez vos applications ! 🐳",
  "GitLab CI : CI/CD : Intégrez et déployez en continu. 🚀",
  "Agilité : Soyez adaptable ! 🔄",
  "DevOps : Surveillez vos applications. 👁️",
  "Git : Commitez souvent, petit à petit. 🤏",
  "Docker : Images légères = déploiements rapides. 💨",
  "GitLab CI : Versionnez vos images Docker dans le CI. 🏷️"
];
...
export function Chat() {
  ...
  async function handleSingleRangeEditOrInsertion(editorState: JSONContent) {
    ...
    let range = codeToEdit[0] as RangeInFileWithContents
    const fileInfo = getFileInfo(range.filepath);

    const sessionLite = {
      history: contextItems,
      text: prompt,
      range: range.range,
    ...
    posthog.capture("edit/sendPrompt", sessionLite);
